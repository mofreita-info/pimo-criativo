...
/* Global circular progress ring used in stats */
.global-progress {
  display: flex;
  align-items: center;
  gap: 0.75rem;
...
.stat-card:hover {
  ...
  background: linear-gradient(180deg, rgba(59, 130, 246, 0.12), rgba(34, 197, 94, 0.12));
}
